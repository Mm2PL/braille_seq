...
async def to_braille_from_image(img: Image, reverse: bool = False, size_percent: typing.Optional[float] = None,
                                max_x: typing.Optional[int] = None, max_y: typing.Optional[int] = None,
                                sensitivity: typing.Tuple[float, float, float, float] = (1, 1, 1, 1),
    ...
    for num, ch in enumerate(channels.copy()):
        channels[num] = ImageChops.multiply(ch, Image.new("L", img.size, sensitivity[num] * 255))
...
if __name__ == '__main__':
    ...
    print(str(asyncio.get_event_loop().run_until_complete(to_braille_from_image(
        _img,
